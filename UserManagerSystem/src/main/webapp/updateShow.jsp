...
body {
    ...
    align-items: center;
        ...
        .result-text { color: #e67e22; font-size: 1.1em; font-weight: 600; }
        .error-msg {
            background: #fdf2f2;
    ...
    <div class="container">
        ...
        %>
            <div class="result-card">
                ...
                <p class="result-text">修改完成！</p>
                <p style="color:#555;margin-top:10px;">影响行数：<%=model.update(id,name,password)%></p>
            </div>
            <div class="btn-group">
                <a href="update.jsp" class="btn btn-back">继续修改</a>
        ...
        %>
            <div class="error-msg">
                <p>❌ 更新失败：<%=e.getMessage()%></p>
            </div>
            <div class="btn-group">
                <a href="update.jsp" class="btn btn-back">返回重试</a>
