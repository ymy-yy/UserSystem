...
body {
    ...
    align-items: center;
        ...
        .result-card {
            background: #f0faf5;
            border: 2px solid #d5f0e2;
            border-radius: 12px;
            padding: 25px;
            margin-bottom: 20px;
        }
        .success-icon { font-size: 3em; margin-bottom: 10px; }
        .result-text { color: #27ae60; font-size: 1.1em; font-weight: 600; }
        .error-msg {
            background: #fdf2f2;
    ...
    <div class="container">
        ...
        %>
            <div class="result-card">
                ...
                <p class="result-text">插入完成！</p>
                <p style="color:#555;margin-top:10px;">影响行数：<%=model.insert(id,name,password)%></p>
            </div>
            <div class="btn-group">
                <a href="insert.jsp" class="btn btn-back">继续新增</a>
        ...
        %>
            <div class="error-msg">
                <p>❌ 插入失败：<%=e.getMessage()%></p>
            </div>
            <div class="btn-group">
                <a href="insert.jsp" class="btn btn-back">返回重试</a>
